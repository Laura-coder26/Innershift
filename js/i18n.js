...
const translations = {
  it: {
    ...
    label_book: 'LIBRO', book_desc: 'di James Clear — Il bestseller su piccole abitudini per grandi cambiamenti.',
    discover_book: 'Scopri il libro →',
  ...
  en: {
    ...
    label_book: 'BOOK', book_desc: 'by James Clear — The bestseller on small habits for big changes.',
    discover_book: 'Discover the book →',
  ...
  es: {
    ...
    label_book: 'LIBRO', book_desc: 'de James Clear — El bestseller sobre pequeños hábitos para grandes cambios.',
    discover_book: 'Descubrir el libro →',
